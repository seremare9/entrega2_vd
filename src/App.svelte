...
<main>
  <div class="header">
    ...
    <h3 class="titulo">Preferencias Musicales</h3>
    <h2 class="subtitulo">Representación visual</h2>
  ...
  <div class="container">
    ...
    <div class="person-container">
      <div class="aspectoNota">
        ...
        <svg width="{TiempoEnHoras(rta.TiempoEnHoras)}"  viewBox="0 0 85 123" fill="{MomentoDeEscucha(rta.Momento)}" xmlns="http://www.w3.org/2000/svg">
            <path d="M42.5 1C42.5 4.5 44.38 8.41001 44.96 9.70001C45.86 11.72 48.12 16.2 61.38 29.28C62.31 30.2 62.34 30.22 62.73 30.61C67.28 35.17 79.19 48.15 81.38 63.28C83.81 80.16 73.39 94.6 72.38 94.28C71.39 93.97 79.31 79.55 74.38 63.28C70.71 51.16 61.82 44.35 60.38 43.28C54.17 38.65 47.95 36.96 44.38 36.28C43.91 25.42 42.97 11.86 42.5 1Z" fill="{MomentoDeEscucha(rta.Momento)}"/>
            <path d="M41.4101 1C41.3001 59.76 41.3201 83.96 41.4101 89C41.4101 89.08 41.4401 90.75 41.4101 93C41.3201 99.8 41.2701 103.2 40.4101 106C38.6101 111.88 33.5901 115.22 32.4101 116C22.4801 122.6 6.10006 120.04 3.41006 113C1.38006 107.69 7.56006 100.93 8.41006 100C19.3101 88.07 39.2601 92.49 41.4101 93" fill="{MomentoDeEscucha(rta.Momento)}"/>
            <path d="M41.4101 1C41.3001 59.76 41.3201 83.96 41.4101 89C41.4101 89.08 41.4401 90.75 41.4101 93M41.4101 93C41.3201 99.8 41.2701 103.2 40.4101 106C38.6101 111.88 33.5901 115.22 32.4101 116C22.4801 122.6 6.10006 120.04 3.41006 113C1.38006 107.69 7.56006 100.93 8.41006 100C19.3101 88.07 39.2601 92.49 41.4101 93ZM42.5 1C42.5 4.5 44.38 8.41001 44.96 9.70001C45.86 11.72 48.12 16.2 61.38 29.28C62.31 30.2 62.34 30.22 62.73 30.61C67.28 35.17 79.19 48.15 81.38 63.28C83.81 80.16 73.39 94.6 72.38 94.28C71.39 93.97 79.31 79.55 74.38 63.28C70.71 51.16 61.82 44.35 60.38 43.28C54.17 38.65 47.95 36.96 44.38 36.28C43.91 25.42 42.97 11.86 42.5 1Z"
            stroke="{MomentoDeEscucha(rta.Momento)}" stroke-width="4" stroke-miterlimit="10"/>
            </svg>
        {:else if rta.Genero == "No Binario"}
        <svg width=50 viewBox="0 0 45 122" fill="{MomentoDeEscucha(rta.Momento)}" xmlns="http://www.w3.org/2000/svg">
        ...
        {:else if rta.Plataforma == "Tidal"}
          <svg height="300" width="300" xmlns="http://www.w3.org/2000/svg" class="difuminado">
            <rect width="200" height="200" x="55" y="55" rx="20" ry="20" fill={GeneroMusical(rta.GeneroMusical)}/>
          </svg>
